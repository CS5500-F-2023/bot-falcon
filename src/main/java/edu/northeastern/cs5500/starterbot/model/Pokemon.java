...
public class Pokemon implements Model {
    ...
    public String buildPokemonStats() {
        ...
        pokemonStatsBuilder.append("Level   : 🌟 ").append(this.level).append("\n");
        pokemonStatsBuilder.append("XP      : 📊 ").append(this.exPoints).append("\n");
        pokemonStatsBuilder.append("Hp      : 🩷 ").append(this.hp).append("\n");
        pokemonStatsBuilder.append("Speed   : 🏃‍♂️ ").append(this.speed).append("\n");
        pokemonStatsBuilder.append(
                String.format(
                        "%s  : 🗡️ Phys. %-3d | 🔮 Sp. %-3d\n",
                        "Attack", this.attack, this.specialAttack));
        pokemonStatsBuilder.append(
                String.format(
                        "%s : 🛡️ Phys. %-3d | 🛡️ Sp. %-3d\n",
                        "Defense", this.defense, this.specialDefense));
